        ...
        >
          <motion.div className="text-center mb-12" variants={itemVariants}>
            ...
            <p className="text-gray-700 max-w-2xl mx-auto">
              Have questions about MUNCGLOBAL Conference 2025 or our programs? We'd love to hear from you! 
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center mb-2">
                  ...
                  <a href="tel:+233302456789" className="text-gray-700 hover:text-blue-600">+233 30 245 6789</a>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a href="https://twitter.com/muncglobal" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-blue-100 transition-colors">
                  ...
                  <a href="https://instagram.com/muncglobal" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-blue-100 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://linkedin.com/company/muncglobal" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-blue-100 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                    </svg>
                  </a>
                  <a href="https://facebook.com/muncglobal" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-blue-100 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
